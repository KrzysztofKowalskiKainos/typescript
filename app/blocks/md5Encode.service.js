...
(function (app) {
    ...
    (function (blocks) {
        'use strict';
        var Md5EncodeService = (function () {
            function Md5EncodeService() {
            }
            Md5EncodeService.prototype.generateMD5 = function (email) {
            ...
            return Md5EncodeService;
        }());
        angular
            .module('app.blocks')
            .service('Md5EncodeService', Md5EncodeService);
